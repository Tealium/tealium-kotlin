...
class PushNotificationAutoTracker(private val context: TealiumContext) : PushNotificationTracker {
    ...
    private val PUSH_NOTIFICATION_PREFIX: String = "push_notification"
    private val PUSH_NOTIFICATION_EVENT_NAME: String = "${PUSH_NOTIFICATION_PREFIX}_received"
    private val PUSH_NOTIFICATION_TITLE: String = "${PUSH_NOTIFICATION_PREFIX}_title"
    private val PUSH_NOTIFICATION_BODY: String = "${PUSH_NOTIFICATION_PREFIX}_body"
    private val PUSH_NOTIFICATION_CATEGORY: String = "${PUSH_NOTIFICATION_PREFIX}_category"
    private val PUSH_NOTIFICATION_TYPE: String = "${PUSH_NOTIFICATION_PREFIX}_type"
